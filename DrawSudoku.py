...
class drawSudoku:
    ...
    def drawGrid(self, screen, size):
        for i in range(10):
            ...
            pygame.draw.line(screen, black, (0, i * self.cellSize), (size, i * self.cellSize), (line_thickness))
            pygame.draw.line(screen, black, (i * self.cellSize, 0), ( i * self.cellSize, size), (line_thickness))
